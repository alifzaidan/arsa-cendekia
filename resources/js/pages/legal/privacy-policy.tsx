                    ...
                    <div className="rounded-lg bg-white p-8 shadow-lg dark:bg-gray-800">
                        ...
                        <div className="prose prose-gray dark:prose-invert max-w-none">
                            <section className="mb-8">
                                ...
                                <p className="text-gray-700 dark:text-gray-300">
                                    ...
                                    Jika Anda tidak menyetujui kebijakan ini, mohon untuk tidak menggunakan layanan kami.
                                </p>
                            </section>
                            ...
                            <section className="mb-8">
                                ...
                                <div className="space-y-4 text-gray-700 dark:text-gray-300">
                                    ...
                                    <div>
                                        ...
                                        <p>Untuk melindungi hak, properti, dan keselamatan Arsa Cendekia, pengguna kami, atau masyarakat umum.</p>
                                    </div>
                        ...
                        <div className="mt-8 border-t border-gray-200 pt-8 text-center dark:border-gray-700">
                            <p className="text-sm text-gray-600 dark:text-gray-400">
                                Dengan menggunakan layanan Arsa Cendekia, Anda menyetujui kebijakan privasi di atas.
                            </p>
