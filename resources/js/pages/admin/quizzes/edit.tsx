...
export default function EditQuestion({ question, setOpen, onSuccess }: EditQuestionProps) {
                    ...
                    <Select
                        ...
                        onValueChange={(val) => {
                            ...
                            if (newType === 'true_false') {
                                updateOptions([
                                    { option_text: 'Benar', is_correct: options[0]?.is_correct ?? false },
                                    { option_text: 'Salah', is_correct: options[1]?.is_correct ?? false },
                                ]);
                            } else {
                                updateOptions(
                                    options.length >= 2
                ...
                <div>
                    ...
                    <div className="mt-2 space-y-2">
                        {type === 'true_false' ? (
                            ...
                            >
                                {options.map((opt, idx) => (
                                    <div key={opt.id ?? idx} className="mb-1 flex items-center space-x-2">
                                        <Input
                                            type="text"
