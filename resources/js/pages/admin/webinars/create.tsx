...
export default function CreateWebinar({ categories, tools }: { categories: { id: string; name: string }[]; tools: { id: string; name: string }[] }) {
    ...
    const form = useForm<z.infer<typeof formSchema>>({
        ...
        defaultValues: {
            ...
            batch: 1,
            tools: [],
            requirement_1: 'Follow Instagram @arsacendekia',
            requirement_2: 'Follow TikTok @arsacendekia',
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <Textarea
                                            ...
                                            value={field.value ?? ''}
                                            className="w-full rounded border p-2"
                                            placeholder="Contoh: Follow Instagram @arsacendekia"
                                            autoComplete="off"
                                        />
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <Textarea
                                            ...
                                            value={field.value ?? ''}
                                            className="w-full rounded border p-2"
                                            placeholder="Contoh: Follow TikTok @arsacendekia"
                                            autoComplete="off"
                                        />
