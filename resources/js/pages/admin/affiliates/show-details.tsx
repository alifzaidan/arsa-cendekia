    ...
    return (
        <div className="space-y-6 rounded-lg border p-4">
            ...
            <div className="flex flex-col gap-4 md:flex-row">
                <Input
                    type="text"
                    value={`https://arsacendekia.id/register?ref=${affiliate.affiliate_code}`}
                    readOnly
                ...
                <Button
                    type="button"
                    onClick={() => {
                        navigator.clipboard.writeText(`https://arsacendekia.id/register?ref=${affiliate.affiliate_code}`);
