...
export function SearchCommand({ open, onOpenChange }: SearchCommandProps) {
    ...
    return (
        <CommandDialog open={open} onOpenChange={onOpenChange}>
            <CommandInput placeholder="Cari kelas atau webinar..." value={query} onValueChange={setQuery} />
            <CommandList className="max-h-[400px]">
                ...
                {/* No query state */}
                {!hasQuery && !loading && (
                    <div className="text-muted-foreground py-6 text-center text-sm">Ketik untuk mencari kelas atau webinar...</div>
                )}
